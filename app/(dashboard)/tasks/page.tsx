  ...
  return (
    <div className="p-6 space-y-4">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>Follow-ups and to-dos</p>
      </div>
      <div className="rounded-xl p-8 text-center" style={{ backgroundColor: "var(--bg-surface)", border: "1px solid var(--border-subtle)" }}>
        <p className="text-sm" style={{ color: "var(--text-muted)" }}>Tasks module coming in Phase 1</p>
      </div>
    </div>
  );
}
